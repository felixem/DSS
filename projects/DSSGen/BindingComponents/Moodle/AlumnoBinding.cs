...
namespace BindingComponents.Moodle
{
    public class AlumnoBinding : BasicBinding
    {
        ...
        public void VincularDameTodos(IDameTodosAlumno consulta, IBinderListaAlumno binder, int first, int size, out long numBases)
        {
        ...
        public void VincularDameAlumno(IDameAlumno consulta, IBinderAlumno linker)
        {
