<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="profesores.aspx.cs" Inherits="DSSGenNHibernate.Profesor.profesores" %>
...
<div class="CentrarContenido">
    ...
    <asp:Panel ID="Panel2" runat="server" CssClass="ContenedorInterno">
        <div class="">
            ...
            <hr />
            <asp:Button ID="Button_Crear" runat="server" Text="Crear profesor" OnClick="Button_Crear_Click" />
            <asp:GridView ID="GridViewBolsas" runat="server" AutoGenerateColumns="False">
                <Columns>
                    <asp:BoundField HeaderText="Id" DataField="Cod_profesor" />
