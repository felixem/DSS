<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="entregas_asignatura.aspx.cs" Inherits="DSSGenNHibernate.Entrega.entregas_asignatura" %>
                ...
                <asp:GridView ID="GridViewBolsas" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acciones">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="lnkEntregas" OnClick="lnkEntregas_Click">Entregas</asp:LinkButton>
