<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="entregas_asignatura_vista_alumno.aspx.cs" Inherits="DSSGenNHibernate.Entrega.entregas_asignatura_vista_alumno" %>
    ...
    <div class="CentrarContenido">
        <div class="ConInternoSinDisplay">
            <asp:Panel ID="Panel1" runat="server" CssClass="ContenedorInterno">
                <h1>
                    <asp:Label ID="Label_Asignatura" runat="server" Text="Listado de Entregas"></asp:Label></h1>
            </asp:Panel>
        </div>
                ...
                <asp:GridView ID="GridViewBolsas" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acciones">
                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="lnkMiEntrega" OnClick="lnkMiEntrega_Click">Mi Entrega</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
