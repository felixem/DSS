...
namespace DSSGenNHibernate.AsignaturaAnyo
{
    public partial class mis_asignaturas_impartidas : BasicPage
    {
        ...
        private void ObtenerAsignaturasPaginadas(int pageIndex)
        {
            ...
            fachadaAsignatura.VincularDameTodosPorAnyoYProfesor(idAnyo, MySession.Current.Usuario.Email, GridViewBolsas, (pageIndex - 1) * pageSize, pageSize, out numObjetos);
