<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="controles.aspx.cs" Inherits="DSSGenNHibernate.Control.controles" %>
...
<div class="CentrarContenido">
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="ContenedorInterno">
        <asp:Label ID="Label_Asignatura" runat="server" Text="Listado de Controles"></asp:Label>
    </asp:Panel>
    </div>
