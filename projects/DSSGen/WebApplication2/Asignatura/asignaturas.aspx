<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="asignaturas.aspx.cs" Inherits="DSSGenNHibernate.Asignatura.asignaturas" %>
    ...
    <div class="CentrarContenido">
        <div class="ConInternoSinDisplay">
            <asp:Panel ID="Panel1" runat="server" CssClass="ContenedorInterno">
                <h1><asp:Label ID="Label_Asignatura" runat="server" Text="Listado de Asignaturas"></asp:Label></h1>
            </asp:Panel>
        </div>
