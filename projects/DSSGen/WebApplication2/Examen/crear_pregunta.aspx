...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="ContenedorInterno">
        ...
        <asp:RadioButtonList CssClass="radioButtonPostBack" ID="RadioButtonListOpciones" runat="server">
        ...
        <asp:Button ID="Button_Limpiar" runat="server" OnClick="Button_Limpiar_Click" Text="Limpiar Campos" />
        </div>
        </asp:Panel>
    </div>
</asp:Content>
