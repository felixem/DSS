...
void Relationer_alumno (int p_tutoria, int p_alumno);
...
void Relationer_profesor (int p_tutoria, int p_profesor);

void Unrelationer_alumno (int p_tutoria, int p_alumno);
...
void Unrelationer_profesor (int p_tutoria, int p_profesor);
}
}
