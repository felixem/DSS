...
void Relationer_alumnos (int p_grupotrabajo, System.Collections.Generic.IList<int> p_alumno);

void Relationer_asignatura (int p_grupotrabajo, int p_asignaturaanyo);

void Unrelationer_alumnos (int p_grupotrabajo, System.Collections.Generic.IList<int> p_alumno);
