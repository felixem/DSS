...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: DSSGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("DSSGenNHibernate", "nhibernateUser", "nhibernatePass");
